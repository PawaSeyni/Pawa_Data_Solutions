...
export const LOCALES = {
  en: {
    ...
    "practitionerNote": "AI readiness work is led by Papa S. Nguer, whose background is enterprise data architecture, governance, MDM and entity resolution, lineage and financial-services controls — plus eighteen years translating vendor capability into production operating patterns. That matters here because the questions an auditor asks about a regulatory figure are the questions you should be asking about a model's inputs.",
    "relatedInsights": [
      {
        "kind": "Solution",
