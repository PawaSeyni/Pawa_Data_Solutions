...
export const LOCALES = {
  en: {
    ...
    "practitionerNote": "Engineering work is led by Papa S. Nguer, whose eighteen years at Informatica covered more than 300 customer-facing engagements for Tier 1 banks, insurers, telecoms and transport operators. The reliability problems in a pipeline estate are rarely novel, which is the good news.",
    "relatedInsights": [
      {
        "kind": "Case study",
  ...
  es: {
    ...
    "practitionerNote": "El trabajo de ingeniería lo dirige Papa S. Nguer, cuyos dieciocho años en Informatica cubrieron más de 300 proyectos con bancos, aseguradoras, telecomunicaciones y transporte de primer nivel. Los problemas de fiabilidad de un parque de pipelines rara vez son inéditos, lo cual es una buena noticia.",
    "relatedInsights": [
      {
  ...
  pt: {
    ...
    "practitionerNote": "O trabalho de engenharia é liderado por Papa S. Nguer, cujos dezoito anos na Informatica cobriram mais de 300 projetos com bancos, seguradoras, telecomunicações e transporte de primeira linha. Os problemas de confiabilidade de um parque de pipelines raramente são inéditos, o que é uma boa notícia.",
    "relatedInsights": [
      {
        "kind": "Estudo de caso",
